...
primary key (name)
  ...
  def test_resharding(self):
    ...
    #                tablet. In that the healthcheck will race with the test and
    #                convert the SPARE tablet back to REPLICA the next time it
    #                runs.
    ...
    utils.pause('run streamhealth manually')
