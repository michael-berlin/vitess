...
type FakePoolConnection struct {
	...
	// mu guards all fields in the group below. (vtworker writes multi-threaded.
	// Therefore, synchronization is required.)
	// This mutex effectiveliy serializes the parallel writes and makes the test
