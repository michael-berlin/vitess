...
func TestVerticalSplitClone(t *testing.T) {
	...
	destMaster.FakeMysqlDaemon.DbAppConnectionFactory = createVerticalSplitCloneDestinationFakeDb(t, "destMaster", 30).getFactory()
	//	destRdonly.FakeMysqlDaemon.DbAppConnectionFactory = createSplitCloneDestinationFakeDb(t, "destRdonly", 0).getFactory()
